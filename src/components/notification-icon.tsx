...
const typeStyles: Record<NotificationType, { icon: LucideIcon; classes: string }> = {
	invoice: {
		icon: BadgeCheckIcon,
		classes: "bg-emerald-100 text-emerald-600 dark:bg-emerald-400/15 dark:text-emerald-400",
	},
	member: {
		icon: UserPlusIcon,
		classes: "bg-blue-100 text-blue-600 dark:bg-blue-400/15 dark:text-blue-400",
	},
	comment: {
		icon: MessageSquareIcon,
		classes: "bg-amber-100 text-amber-600 dark:bg-amber-400/15 dark:text-amber-400",
	},
